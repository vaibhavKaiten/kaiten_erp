frappe.ui.form.on("Delivery Note", {
    refresh: function(frm) {
        ...
        // Fallback: check custom_linked_sales_order on the DN header
        if (!so_name && frm.doc.custom_linked_sales_order) {
            so_name = frm.doc.custom_linked_sales_order;
        }
        ...
        frappe.call({
            ...
            callback: function(r) {
                ...
                frm.doc.custom_linked_sales_order = so_name;

                frm.refresh_field("items");
                frm.refresh_field("custom_linked_sales_order");
